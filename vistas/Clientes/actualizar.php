        ...
        <main role="main" class="col-12 col-md-10 px-md-4 py-md-5 py-2">
            <div class="text-center">
                <img class="mb-4 img-fluid" src="<?php assets("img/user_bussines.png") ?>" alt="" width="60"
                     height="60">
                <h3 class="alert-secondary">ACTUALIZAR CLIENTE</h3>
            </div>

            <form class="row" id="registrar" method="post" action="<?php url("cliente/actualizar") ?>">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="nombre" id="nombre" class="form-control text-capitalize"
                           value="<?= $cliente->__get("nombre")?>" placeholder="Ingrese Nombre Completo" required>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" name="identificacion" id="identificacion" class="form-control"
                           value="<?= $cliente->__get("identificacion") ?>" placeholder="Ingrese Cedula" required>
                </div>


                <div class="col-md-6">
                    <label for="email" class="col-form-label">Email</label>
                    <input type="email" name="email" id="email" value="<?= $cliente->__get("email")?>" class="form-control" placeholder="Ingrese Correo"
                           required>
                </div>

                <div class="col-md-6">
                    <label for="celular" class="col-form-label">Celular</label>
                    <input type="tel" name="celular" id="celular" value="<?= $cliente->__get("celular")?>" class="form-control" placeholder="Ingrese Celular"
                           pattern="[0-9]{7-10}" minlength="7" maxlength="10" title="Debe contener minimo 7 digitos, maximo 10">
                </div>

                <div class="col-md-6">
                    <label for="direccion" class="col-form-label">Direccion</label>
                    <input type="text" name="direccion" id="direccion" value="<?= $cliente->__get("direccion")?>" class="form-control" placeholder="Ingrese Direccion"
                           required>
                </div>
